...
void ui_Screen5_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_Button3, lv_color_hex(0x838583), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_Button13, lv_color_hex(0x3577D1), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_Label23, "开始录音");
